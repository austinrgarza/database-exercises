...
INSERT INTO albums (artist_name, record_name, release_date, genre, sales)VALUES ('Michael Jackson', 'Thriller', 1982, 'Pop, Rock, R&B', 47.3),
...
('Eagles', 'Their Greatest Hits (1971–1975)', 1976, 'Rock, Soft rock, Folk rock', 32.3),
...
('James Horner', 'Titanic: Music from the Motion Picture', 1997, 'Soundtrack', 18.2),
...
('Santana', 'Supernatural', 1999, 'Rock', 0.5),
